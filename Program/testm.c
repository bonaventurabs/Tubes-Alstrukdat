...
#include "./array_statis(listofpoint)/ListPoint.c"
#include "./array_dinamis(komponen)/arrayKomponen.c"
#include "./array_dinamis(inventory)/arrayInventory.c"
#include "./array_dinamis(delivery)/arrayDelivery.c"
